...
adamax = keras.optimizers.Adamax(lr=0.0001, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.0) #lr = 0.002
...
## SAVING THE MODEL
model.save("./Models/Histology_IC_adamax_SCC_lr0.0001_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Adamax_lr:0.0001_model.png')
...
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Adamax_lr:0.0001.png', transparent = True, bbox_inches = "tight")
