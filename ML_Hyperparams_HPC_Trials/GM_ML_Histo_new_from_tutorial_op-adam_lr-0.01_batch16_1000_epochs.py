...
adam = keras.optimizers.Adam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=1e-8)#lr = 0.001
...
## SAVING THE MODEL
model.save("./Models/Histology_IC_adam_SCC_lr0.01_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Adam_lr:0.01_model.png')
...
# plt.show()
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Adam_lr:0.01.png', transparent = True, bbox_inches = "tight")
