...
adagrad = keras.optimizers.Adagrad(lr=0.002, epsilon=1e-6)#lr = 0.01
...
## SAVING THE MODEL
model.save("./Models/Histology_IC_adagrad_SCC_lr0.002_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Adagrad_lr:0.002_model.png')
...
# plt.show()
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Adagrad_lr:0.002.png', transparent = True, bbox_inches = "tight")
