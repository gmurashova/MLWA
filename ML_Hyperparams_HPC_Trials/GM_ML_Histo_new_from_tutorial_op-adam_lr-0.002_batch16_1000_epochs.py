...
## SAVING THE MODEL
model.save("./Models/Histology_IC_adam_SCC_lr0.002_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Adam_lr:0.002_model.png')
...
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Adam_lr:0.002.png', transparent = True, bbox_inches = "tight")
