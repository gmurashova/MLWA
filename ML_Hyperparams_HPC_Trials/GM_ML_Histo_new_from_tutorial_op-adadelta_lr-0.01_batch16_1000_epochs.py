...
adadelta = keras.optimizers.Adadelta(lr=0.01, rho=0.95, epsilon=1e-6)#lr = 1.0
...
## SAVING THE MODEL
model.save("./Models/Histology_IC_adadelta_SCC_lr0.01_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Adadelta_lr:0.01_model.png')
...
# plt.show()
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Adadelta_lr:0.01.png', transparent = True, bbox_inches = "tight")
