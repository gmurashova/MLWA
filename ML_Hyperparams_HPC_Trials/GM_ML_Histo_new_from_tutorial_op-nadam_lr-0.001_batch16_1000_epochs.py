...
## SAVING THE MODEL
model.save("./Models/Histology_IC_nadam_SCC_lr0.001_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Nadam_lr:0.001_model.png')
...
# plt.show()
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Nadam_lr:0.001.png', transparent = True, bbox_inches = "tight")
