...
adam = keras.optimizers.Adam(lr=0.002, beta_1=0.9, beta_2=0.999, epsilon=1e-8)#lr = 0.001
adamax = keras.optimizers.Adamax(lr=0.002, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.0) #lr = 0.002
nadam = keras.optimizers.Nadam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=None, schedule_decay=0.004)#lr = 0.002
adagrad = keras.optimizers.Adagrad(lr=0.01, epsilon=1e-6)#lr = 0.01
adadelta = keras.optimizers.Adadelta(lr=0.0001, rho=0.95, epsilon=1e-6)#lr = 1.0
...
## SAVING THE MODEL
model.save("./Models/Histology_IC_adadelta_SCC_lr0.0001_BS16_E1000.h5")
...
plot_model(model, to_file='./Figures/Opt:Adadelta_lr:0.0001_model.png')
...
fig.savefig('./Figures/Training_and_Testing_Accuracy_and_Loss_Opt:Adadelta_lr:0.0001.png', transparent = True, bbox_inches = "tight")
