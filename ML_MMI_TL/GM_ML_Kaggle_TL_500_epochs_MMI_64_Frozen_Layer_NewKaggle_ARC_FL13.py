...
plt.savefig('./TL_Figures_NK_ARC_FL13/Random_Trained_Image_'+input_runname+'.png', bbox_inches = "tight", transparent = True)
###########################################################################
...
plt.savefig('./TL_Figures_NK_ARC_FL13/Images_Viewed_'+input_runname+'.png', bbox_inches = "tight", transparent = True)
###########################################################################
...
plot_model(new_model, to_file='./TL_Figures_NK_ARC_FL13/Kaggle_Opt-Adam_ReduceLR_10e-3_model_'+input_runname+'.png')
###########################################################################   
...
for i in range(0,9):
    ...
    im = train_images[i]
    plt.imshow(im)
    plt.savefig('./TL_Figures_NK_ARC_FL13/64x64_New_Kaggle_MMI_ARC_Augmented.png', bbox_inches = "tight")
plt.show()
###########################################################################              
...
print(end - start)
## SAVING THE MODEL########################################################
new_model.save("./TL_Models_NK_ARC_FL13/Histology_IC_adam_SCC_lr-0.001_BS16_E400__NoAug_"+input_runname+".h5")
...
plt.savefig('./TL_Plots_NK_ARC_FL13/Training_and_Testing_Accuracy_and_Loss_Opt-Adam_lr-0.001_NoAug_'+input_runname+'.png', transparent = True, bbox_inches = "tight")
########################################################################### 
# 
