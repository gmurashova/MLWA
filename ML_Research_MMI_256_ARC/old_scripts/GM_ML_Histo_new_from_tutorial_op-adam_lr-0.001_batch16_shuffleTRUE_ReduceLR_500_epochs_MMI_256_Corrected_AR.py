...
Y = np.load('./TILES_256_AR_Corrected/MMI_OHE_class_labels.npy')
...
train_images = train_images_a.reshape((288, 192,192))
train_labels = np.array(y_train)

test_images_a = np.array(x_val)
test_images = test_images_a.reshape((72, 192,192))
...
model = keras.Sequential([
    keras.layers.Conv2D(32,kernel_size = (3,3), input_shape = (192,192,1),activation = tf.nn.relu, padding = "valid"),
...
train_images = train_images.reshape(288, 192,192, 1)
print(np.shape(train_images))

test_images = test_images.reshape(72, 192,192, 1)
