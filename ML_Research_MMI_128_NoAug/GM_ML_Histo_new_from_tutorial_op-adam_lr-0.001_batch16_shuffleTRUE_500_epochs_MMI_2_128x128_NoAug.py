...
plt.grid(False)
# plt.show()
plt.savefig('./MMI_NoAug_Figures/Random_Trained_Image_NoAug'+input_runname+'.png', bbox_inches = "tight", transparent = True)
#
...
for i in range(25):
    ...
    if train_labels[i] == 0:
        ...
        plt.xlabel(class_names[0])
# plt.show()
plt.savefig('./MMI_NoAug_Figures/Images_Viewed_NoAug'+input_runname+'.png', bbox_inches = "tight", transparent = True)
...
############## WITH DATA GENERATOR ################## --> must use this bc my data wont all fit into memory at once!
...
## SAVING THE MODEL
model.save("./MMI_NoAug_Models/Histology_IC_adam_SCC_lr-0.001_BS16_E400__NoAug_"+input_runname+".h5")
...
# plt.show()
plt.savefig('./MMI_NoAug_Plots/Training_and_Testing_Accuracy_and_Loss_Opt-Adam_lr-0.001_NoAug_'+input_runname+'.png', transparent = True, bbox_inches = "tight")
