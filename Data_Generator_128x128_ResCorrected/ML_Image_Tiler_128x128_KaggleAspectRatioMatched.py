...
for name in ARC_files:
    ...
    i += 1
    name3 = str(i)
    tiles = image_slicer.slice(name, 9, save=False) ### dimmensions/image size = # of images, square # of images to put into parameters
    image_slicer.save_tiles(tiles, directory='/Users/gabrielleosborn-lipsitz/MOVE_BACK_TO_DESKTOP/ML_Research/MMI_128x128_AR_Corrected/TILES_128_AR_Corrected',prefix=name2+'_'+name3+'_slice', format='png')
