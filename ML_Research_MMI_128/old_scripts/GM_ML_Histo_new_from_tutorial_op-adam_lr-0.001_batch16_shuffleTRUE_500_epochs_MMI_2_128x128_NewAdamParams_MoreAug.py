...
Y = np.load('./TILES/MMI_OHE_class_labels.npy')
...
train_images = train_images_a.reshape((1152,128,128))
train_labels = np.array(y_train)

test_images_a = np.array(x_val)
test_images = test_images_a.reshape((288,128,128))
...
train_images = train_images.reshape(1152, 128, 128, 1)
print(np.shape(train_images))

test_images = test_images.reshape(288, 128, 128, 1)
