...
for name in ARC_files:
    ...
    image_slicer.save_tiles(tiles, directory='/Users/gabrielleosborn-lipsitz/MOVE_BACK_TO_DESKTOP/ML_Research/MMI_256x256_AR_Corrected/TILES_256_AR_Corrected',prefix=name2+'_'+name3+'_slice', format='png')
