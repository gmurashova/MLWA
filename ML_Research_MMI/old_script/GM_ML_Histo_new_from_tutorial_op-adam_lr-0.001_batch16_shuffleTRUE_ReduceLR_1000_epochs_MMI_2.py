...
train_images = train_images_a.reshape((4608,64,64))
train_labels = np.array(y_train)

test_images_a = np.array(x_val)
test_images = test_images_a.reshape((1152,64,64))
...
train_images = train_images.reshape(4608, 64, 64, 1)
print(np.shape(train_images))

test_images = test_images.reshape(1152, 64, 64, 1)
