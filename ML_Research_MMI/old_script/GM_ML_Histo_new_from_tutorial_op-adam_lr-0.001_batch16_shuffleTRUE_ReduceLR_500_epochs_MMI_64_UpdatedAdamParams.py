...
plt.grid(False)
# plt.show()
plt.savefig('./MMI_Figures_UAP/Random_Trained_Image_'+input_runname+'.png', bbox_inches = "tight", transparent = True)
#
...
for i in range(25):
  ...
  #       plt.xlabel(class_names[7])
        ...
        plt.xlabel(class_names[0])
# plt.show()
plt.savefig('./MMI_Figures_UAP/Images_Viewed_'+input_runname+'.png', bbox_inches = "tight", transparent = True)
...
## SAVING THE MODEL
model.save("./MMI_Models_UAP/Histology_IC_adam_SCC_lr-0.001_BS16_E400__NoAug_"+input_runname+".h5")
...
# plt.show()
plt.savefig('./MMI_Plots_UAP/Training_and_Testing_Accuracy_and_Loss_Opt-Adam_lr-0.001_NoAug_'+input_runname+'.png', transparent = True, bbox_inches = "tight")
