...
Y = np.load('./TILES_85/MMI_OHE_class_labels.npy')
...
train_images = train_images_a.reshape((2592,85,85))
train_labels = np.array(y_train)

test_images_a = np.array(x_val)
test_images = test_images_a.reshape((648,85,85))
...
model = keras.Sequential([
    keras.layers.Conv2D(32,kernel_size = (3,3), input_shape = (85,85,1),activation = tf.nn.relu, padding = "valid"),
...
train_images = train_images.reshape(2592,85,85, 1)
print(np.shape(train_images))

test_images = test_images.reshape(648,85,85, 1)
